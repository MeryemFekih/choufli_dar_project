...
<nav class="navbar navbar-expand-lg ">
        ...
        <div class="container-fluid  flex-wrap ">
            <div class="row" >
                <div class="col-md-6 d-flex justify-content-around flex-wrap"  id="cards"> 
                   
                    <?php include 'binomee.php'; ?>

                                  
                </div>
                <div class="col-md-6"  id="postuler">                
                    <div>
                <section class="container">
                    <header>Registration Form</header>
                    <form class="form" action="binomee.php" method="post" enctype="multipart/form-data">

                    <div class="input-box">
                            <label>Your cin</label>
                            <input type="number" name="cin" placeholder="your cin">
                        </div>
                        <div class="input-box">
                        ...
                        <div class="column">
                            ...
                            <input type="text" value="full name" name="fullname">
                            </div>
                            <div class="input-box">
                            <label>Your phone number :</label>
                            <input type="number" name="phnumber" placeholder="your num">
                            </div>
                            </div>
                        ...
                        <div class="gender-option">
                            <div class="gender">
                                <input type="radio"  value="F" name="g" id="1">
                                <label for="check-female">Female</label>
                                <input type="radio"  value="H" name="g" id="2">
                                <label for="check-female">Male</label>

                            </div>
                            <!--<div class="gender">
                                <input type="radio"  value="H" name="bedroom" id="2">
                                <label for="check-female">Male</label>
                            </div>-->
                        ...
                        <div class="input-box">
                            ...
                            <input required="" name="desc"  placeholder="description" type="text">
                        </div>
